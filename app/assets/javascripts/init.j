...
window.onload = function()
{
     ...
     */
    queue.loadManifest([
        {id: 'backgroundImage', src: 'assets/lockerroom.jpg'},
        {id: 'crossHair', src: 'assets/crosshair.png'},
        {id: 'shot', src: 'assets/sounds/shot.mp3'},
        {id: 'background', src: 'assets/sounds/countryside.mp3'},
        {id: 'gameOverSound', src: 'assets/sounds/gameOver.mp3'},
        {id: 'tick', src: 'assets/sounds/tick.mp3'},
        {id: 'deathSound', src: 'assets/sounds/die.mp3'},
        {id: 'catSpritesheet', src: 'assets/cat-sprites.png'},
...
function queueLoaded(event)
{
    ...
    //Add Score
    scoreText = new createjs.Text("1UP: " + score.toString(), "16px Arial", "#FFF");
    scoreText.x = 10;
    scoreText.y = 10;
    stage.addChild(scoreText);

    //Ad Timer
    timerText = new createjs.Text("Time: " + gameTime.toString(), "16px Arial", "#FFF");
    timerText.x = 330;
    timerText.y = 10;
    ...
    spriteSheet = new createjs.SpriteSheet({
        "images": [queue.getResult('catSpritesheet')],
...
function createEnemy()
{
    ...
    animation2 = new createjs.Sprite(spriteSheet, "celebrate");
    animation.regX = 99;
    animation.regY = 58;
    animation.x = enemyXPos;
    animation.y = enemyYPos;
    animation.gotoAndPlay("walk");
    animation2.gotoAndPlay("celebrate");
    stage.addChildAt(animation,1);
    stage.addChildAt(animation2,1);
}
